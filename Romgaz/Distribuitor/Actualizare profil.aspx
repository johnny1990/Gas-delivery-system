<%@ Page Language="C#" MasterPageFile="~/Distribuitor/Distribuitor.master" AutoEventWireup="true" CodeFile="Actualizare profil.aspx.cs" Inherits="Distribuitor_Actualizare_profil" Title="Untitled Page" %>
                    ...
                    <table style="border: thin solid #5D7B9D; background-color: Window;  width: 670px;">
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtTelefon" runat="server" ></asp:TextBox>
                                                         <asp:RegularExpressionValidator ID="regPhone" ControlToValidate="txtTelefon" runat="server" 
                        ...
                        <td colspan="3">
                            &nbsp;</td>
                        <td colspan="3">
                         <asp:Button ID="btnActualizare" runat="server"  Text="Actualizare" 
...
<div id="divChangePss" visible="false"   runat="server">
                    ...
                    <table style="border: thin solid #5D7B9D; background-color:window;  width: 400px;">
                        ...
                        <td >
                            Parola veche</td>
                        <td >
                        <asp:TextBox ID="txtVechi" TextMode="Password" runat="server"></asp:TextBox>
                        </td>
                        <td >
                           <asp:RequiredFieldValidator ID="rfvVechi" runat="server" ErrorMessage="*" ControlToValidate="txtVechi"></asp:RequiredFieldValidator> 
                        </td>                        
                        </tr>
                        <tr>
                        <td colspan="3"></td>
                        ...
                        <td >
                           <asp:RequiredFieldValidator ID="rfvNou" runat="server" ErrorMessage="*" ControlToValidate="txtNou"></asp:RequiredFieldValidator> 
                        </td>    
                        </tr>
                        <tr>
                        <td colspan="3"></td>
                        ...
                        <td colspan="2">
                         <asp:Button ID="btnActualizareParola" runat="server"  Text="Actualizeaza" ForeColor="White"
